...
export default {
    ...
    methods: {
        ...
        getDataFromApi(task_id, project_id) {
            const self = this;
            axios
                .get('/enginner_office/project-tasks/' + task_id, {
                    params: { project_id: project_id },
                })
                .then(function (response) {
                    console.log(response.data);
                    if (response.data.success) {
                        self.task = response.data.msg;
                        self.taskActivity = response.data.msg.task_creator;
                        self.project = response.data.msg.project;
                        self.task_members = response.data.msg.task_members;
        ...
        updateDescription() {
            const self = this;
            axios
                .get('/enginner_office/project-task-description/', {
                    params: {
                        id: self.task.id,
