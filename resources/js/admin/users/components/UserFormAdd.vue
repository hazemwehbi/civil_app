                    ...
                    <v-layout row wrap>
                        ...
                        <v-flex xs12 sm6>
                            <v-text-field
                                ...
                                :data-vv-as="trans('messages.confirm_password')"
...
export default {
    ...
    data() {
        ...
        return {
            ...
            passwordConfirm: '',
            passwordConfirmRules: [(v) => !(v !== self.password) || 'Password do not match.'],
            active: true,
            roles: [],
            send_email: false,
            enginnering_type: '',
    ...
    mounted() {
        ...
        self.checkCurrentUserType('ENGINEERING_OFFICE');
    ...
    methods: {
        ...
        checkCurrentUserType(type){
            const self=this;
            axios
                .get('/check-current-user-type/'+ type).then(function(response){
//alert()
