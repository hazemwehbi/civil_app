    ...
    <v-container justify-center>
        <v-form ref="form" v-model="valid" lazy-validation>
            <v-card-actions justify-left>
                ...
                <v-btn
                    v-if="design_enginner.is_rejected1 != 1"
                    style="background-color: #06706d; color: white"
                    color="darken-1"
                    @click="accept(1)"
                    :loading="loading"
                    :disabled="!valid || !checkActive() || design_enginner.is_agreed1==1"
                >
                    {{
                        design_enginner.is_agreed1 ? trans('data.accepted_done') : trans('data.accept')
                    }}
                </v-btn>

                <v-btn
                    v-if="design_enginner.is_agreed1 != 1"
                    style="background-color: #06706d; color: white"
                    color="darken-1"
                    @click="accept(0)"
                    :loading="loading"
                    :disabled="!valid || !checkActive() || design_enginner.is_rejected1==1"
                >
                    {{
                        design_enginner.is_rejected1
