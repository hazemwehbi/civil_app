        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                ...
                <v-tabs dark color="#00695c" class="background-color" show-arrows>
                    <v-tab> {{ trans('data.view_contract_details') }}</v-tab>
                                ...
                                <v-container grid-list-md>
                                    ...
                                    <v-layout row>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field v-model="contractors_name" :readonly="true"
                                                :label="trans('data.contractors_name')"></v-text-field>
                                        </v-flex>
...
export default {
    ...
    methods: {
        ...
        create(data) {
            ...
            self.contractors_name = data.supporters.map(x => x.name).join(',')
