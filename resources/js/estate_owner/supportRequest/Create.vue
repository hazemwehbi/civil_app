                            ...
                            <v-layout row>
                                <v-flex xs12 sm12 md12>
                                    <v-autocomplete class="content-sign" multiple :clearable="true"
                                        ...
                                        color="#00695c" :items="supporters" v-model="design.supporters"
...
export default {
    ...
    beforeDestroy() {
        const self = this;
        self.$eventBus.$off('SUPPORT_ADDED');
    },
    filters: {
    ...
    methods: {
        ...
        store(sent) {
            ...
            if (this.$refs.form.validate()) {
                self.loading = true;
                axios
                    .post('/estate_owner/request-support', data)
                    .then(function (response) {
                        if (!response.data.error_code) {
                            ...
                            self.$eventBus.$emit('SUPPORT_ADDED');
