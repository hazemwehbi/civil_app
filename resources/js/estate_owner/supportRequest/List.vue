    ...
    methods: {
        sendRequest(id) {
            ...
            self.$store.commit('showDialog', {
                ...
                okCb: () => {
                    axios
                        .post('/estate_owner/confirm-support', { id: id })
                        .then(function (response) {
                            if (response.data.success === true) {
                                self.$eventBus.$emit('SUPPORT_UPDATED');
        ...
        trash(id) {
            ...
            self.$store.commit('showDialog', {
                ...
                okCb: () => {
                    axios
                        .delete('/estate_owner/request-support/' + id)
                        .then(function (response) {
                            if (response.data.success === true) {
                                self.$eventBus.$emit('SUPPORT_DELETED');
                                self.$store.commit('showSnackbar', {
                                    message: response.data.msg,
                                    color: response.data.success,
                                });
        ...
        loadRequests(cb) {
            ...
            axios
                .get('/estate_owner/request-support', { params: params })
                .then(function (response) {
                    if (response.data.success === true) {
