        ...
        <AddRequestType ref="RequestTypeAdd"></AddRequestType>
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn style="background-color:#06706d;color:white;" color="darken-1" @click="update" :loading="loading" :disabled="loading">
...
export default {
    ...
    methods: {
        setVisitRequest(){
            ...
            self.request_type=self.visit_request.request_type_id;
            ...
            self.priorities=self.visit_request.priority;  
