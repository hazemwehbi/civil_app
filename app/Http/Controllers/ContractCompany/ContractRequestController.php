...
namespace App\Http\Controllers\ContractCompany;
...
class ContractRequestController extends  Controller
{
    ...
    public function index(Request $request)
    {
      ...
      //  array_push($childrens,$user->id);
        $requests = SupportRequest::where('type','contract')->with('customer','project','supportRequestUsers','supporters')->where('status','!=','new')->whereHas('supporters', function ($q) use ($user) {
...
//'supportRequestUsers'
   ...
   public function sendContractOffer(Request $request)
   {
             ...
             //  $project =Project::find($support_service->project_id);
               //send notifiaction
                 $data=[
                     ...
                     'link'=>'show_contract_request_price_estate_owner'
                 ];
