...
class ContractRequestController extends  Controller
{
    ...
    public function index(Request $request)
    {
      ...
      //  array_push($childrens,$user->id);
        $requests = SupportRequest::where('type','contract')->with('supportRequestUsers','customer','project','supporters')->where('customer_id', $user->id);
        ...
        try {
           ...
           // die();
            ...
            if($request->sent== 1){
                $data=[
                    'estate_id'=> Auth::id(),
                    'link'=> 'support_request_contract_list'
                ];
                foreach($request->supporters as $item){
        ...
        try {
            ...
            if($support_user!=  null){
                ...
                $data=[
                    ...
                    'link'=>'create_report_price_contract'
                ];
